...
export class AreaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    // Chart Color Data Get FunctionF
    this._basicAreaChart()
    this._splineAreaChart('["--vz-primary", "--vz-info"]');
    this._datetimeXaxisChart();
    this._nagativeValueChart('["--vz-primary", "--vz-info"]');
    this._githubmMonthAreaChart();
    this._githubmYearAreaChart();
    this._stackedAreaChart();
    this._irregularTimeseriesChart();
    this._nullValuesAreaChart();
  }
...
*/
  private _githubmMonthAreaChart() {
 ...
 */
  ...
  private _irregularTimeseriesChart() {
